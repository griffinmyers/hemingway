  ...
  describe LatexParser do
    ...
    describe "#itemize" do
      ...
      it 'supports items to have labels on them with various spacing' do
        ...
        html.should == "<div class='document'><p><ul><li><span class='list-label'>bros</span> over hoes </li><li><span class='list-label'>chicks</span> before dicks </li></ul></p></div>"
      end
      ...
      it 'supports text, tags, special chars, and math in labels' do
        ...
        html.should == "<div class='document'><p><ul><li><span class='list-label'>so many <em>vibes</em> &lambda; $ $</span> to be had </li></ul></p></div>"
      end

      it 'supports empty labels' do
        html = @parser.parse("\\begin{itemize}\\item[] do or do not \\end{itemize}").html
        html.should == "<div class='document'><p><ul><li><span class='list-label'></span> do or do not </li></ul></p></div>"
      end
      ...
      it 'supports empty items with labels' do
        ...
        html.should == "<div class='document'><p><ul><li><span class='list-label'>Millenium <em>Falcon</em></span> </li><li>Slave-1 </li></ul></p></div>"
      end
      ...
      it 'should allow me to nest some lists' do
        ...
        html.should == "<div class='document'><p><ul><li><span class='list-label'>another list</span> <ul><li><span class='list-label'>nesting <em>vibes</em></span> over here </li></ul> </li><li>for good measure </li></ul></p></div>"
      end
    ...
    describe "#enumerate" do
      it 'should allow me to create an ordered list' do
        ...
        html.should == "<div class='document'><p><ol><li>Frodo </li><li>Sam </li></ol></p></div>"
      end
      ...
      it 'should allow me to nest an unordered list in an ordered list' do
        ...
        html.should == "<div class='document'><p><ol><li><ul><li>Frodo </li><li>Pippin </li></ul> </li><li>Sam </li></ol></p></div>"
      end
    end
    ...
    describe "#description" do
      it 'should allow me to create a dictionary list' do
        ...
        html.should == "<div class='document'><p><dl><dd>Frodo </dd><dd>Sam </dd></dl></p></div>"
      end
      ...
      it 'should wrap labels in the dictionary label tag' do
        ...
        html.should == "<div class='document'><p><dl><dd><dt>Frodo</dt> Adventuerer </dd><dd><dt>Sam</dt> Faithful Companion </dd></dl></p></div>"
      end
    end
