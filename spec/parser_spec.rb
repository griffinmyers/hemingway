...
module Hemingway
  ...
  describe LatexParser do
    ...
    it 'should parse an emph tag' do
      ...
      html.should == "<div class='document'><p><span class='emph'>hey</span></p></div>"
    end

    it 'should parse a texttt tag' do
      html = @parser.parse("\\texttt{hey}").html 
      html.should == "<div class='document'><p><span class='texttt'>hey</span></p></div>"
    end
    ...
    it 'should allow me to nest tags' do
      ...
      html.should == "<div class='document'><p><span class='emph'><span class='texttt'>hey</span></span></p></div>"
    end

    it 'should REALLY allow me to next tags' do
      html = @parser.parse("\\emph{\\texttt{\\texttt{hey}}}").html 
      html.should == "<div class='document'><p><span class='emph'><span class='texttt'><span class='texttt'>hey</span></span></span></p></div>"
    end
